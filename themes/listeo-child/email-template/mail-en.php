    ...
    <tr>
      <td style="background-image: url(https://book-a-bubble.de/wp-content/uploads/2025/05/Bild-14.jpg); background-size: cover; background-position: center; background-color: #1a1a1a; padding:40px 20px; text-align:center;">
        <div style="display:inline-block; background:rgba(0, 0, 0, 0); padding:30px; border-radius:4px;">
          ...
          <h1 style='color:white; font-size:28px; margin-top:20px; font-family:Arial, sans-serif;'>Your adventure is waiting for you, <?php echo esc_html($first_name); ?>!</h1>
        </div>
      </td>
    </tr>
  </table>
  ...
  <![endif]-->
    ...
    <div class='content' style='padding:30px 0;'>
        <div class='text-block' style='padding:10px 20px; margin-bottom:10px; background-color:#ffffff; border-radius:8px; line-height:1.6;'>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;">Imagine this: the sky above you. The forest around you. The peace of nature. And the two of you – in your own Bubble Tent. No noise, no appointments – just you, nature, and a night under the starry sky. You treated yourself to something special. Ready for unforgettable moments together?</p>
        </div>
        ...
        <div class='info-box' style='background-color:#f2f2f2; padding:20px; border-radius:8px; margin-bottom:20px;'>
            ...
            &nbsp;&nbsp;&nbsp; <img width="24px" style="width:24px;margin-right:5px;vertical-align:middle;" src="<?php echo get_stylesheet_directory_uri();?>/assets/images/people-fill-1.png" alt=""> <strong>Children:</strong> <?php echo $kids; ?>
            </p>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;text-align:left;"><img width="24px" style="width:24px; margin-right:5px; vertical-align:middle;" src="<?php echo get_stylesheet_directory_uri();?>/assets/images/credit-card.png" alt=""> <strong>Payment method:</strong> <?php echo $payment_method; ?></p>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;text-align:left;">
                <img width="24px" style="width:24px; margin-right:5px; vertical-align:middle;" src="<?php echo get_stylesheet_directory_uri();?>/assets/images/credit-card.png" alt=""> <strong>Amount:</strong> <?php echo wc_price($order_price); ?>
            </p>
        </div>
        ...
        <div class='payment-box' style='background-color:#fef9f5; border-left:4px solid #54774e; padding:15px 20px; margin-bottom:20px;text-align:left;'>
            <?php if ( ($payment_method == 'Prepayment by bank transfer' || $payment_method == 'Vorkasse per Überweisung') && $order_status == 'on-hold'): ?>
                <p style='color:#b00020;font-size:16px;line-hight:1.3;margin:0;'><strong>Payment pending</strong>
                <p style="color:#b00020;font-size:16px;line-hight:1.3;margin:0;">Please transfer the amount to the following account within 5 days:</p>
            ...
            <?php else: ?>
                <p style='color:#54774e;font-size:16px;line-hight:1.3;'><strong>Payment confirmed</strong> – everything is ready for your experience.</p>
            <?php endif; ?>
        </div>

        <div class='button-container' style='text-align:center; margin:30px 0 10px 0;'>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;">In your booking portal you’ll find all information about your stay, invoice, and check-in:</p>
            <?php 
                ...
                if ($order_lang === 'en') {
                    ...
                    $lang_link = '/order-detail-page/?order_id='.$order_id;
                }
            ?>
            ...
            <p style='font-style:italic; margin-top:10px;font-size:16px;line-hight:1.3;color:#54774e;'>Couldn’t redeem your voucher? Use the form on the order overview page.</p>
        </div>

        <div class='text-block' style='text-align:center; background-color:#f2f2f2; padding:20px; border-radius:8px;'>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;">f you have questions about your booking or stay, please use the form on the order overview page.<br><strong>Do not reply to this email.</strong></p>
        </div>
    ...
    <div class='footer' style='text-align:center; color:#888888; padding:20px;font-size:16px;line-hight:1.3;'>
        <p>
            ...
            <a href='https://book-a-bubble.de/impressum/' style='color:#54774e; text-decoration:none;font-size:16px;line-hight:1.3;'>Legal Notice</a> |
