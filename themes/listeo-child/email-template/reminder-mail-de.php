    ...
    <tr>
      <td style="background-image: url(https://book-a-bubble.de/wp-content/uploads/2025/05/Bild-14.jpg); background-size: cover; background-position: center; background-color: #1a1a1a; padding:40px 20px; text-align:center;">
        <div style="display:inline-block; background:rgba(0, 0, 0, 0); padding:30px; border-radius:4px;">
          ...
          <h1 style='color:white; font-size:28px; margin-top:20px; font-family:Arial, sans-serif;'>Morgen ist es so weit!</h1>
        </div>
      </td>
    </tr>
  </table>
  ...
  <![endif]-->
    ...
    <div class='content' style='padding:30px 0;'>
        <div class='text-block' style='padding:10px 20px; margin-bottom:10px; background-color:#ffffff; border-radius:8px; line-height:1.6;'>
            <p style="font-size: 16px;line-height: 1.3;color: #2e4034;">Morgen beginnt dein Abenteuer im Bubble Tent. Wenn du noch Anreiseinfos benötigst, klicke bitte auf den Button: Dort findest du den Link zum Standort, die Adresse und unseren Onepager mit allen wichtigen Details. In deinem Buchungsportal findest du außerdem alle Informationen zu deinem Aufenthalt, zur Rechnung und zum Check-in.</p>
        </div>
