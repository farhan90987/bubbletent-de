 ...
 */
function wt_sc_update_message( $data ) {
...
add_action( 'in_plugin_update_message-wt-smart-coupons-for-woocommerce/wt-smart-coupon.php', 'wt_sc_update_message' );
...
if ( /**
	 ...
	 */
	in_array( 'wt-smart-coupon-pro/wt-smart-coupon-pro.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ), true )
	/**
	 * Filter hook to alter active plugins.
	 *
	 * @since 1.0.0
	 ...
	 * @return array Active plugins.
	 */
	|| array_key_exists( 'wt-smart-coupon-pro/wt-smart-coupon-pro.php', apply_filters( 'active_plugins', get_site_option( 'active_sitewide_plugins', array() ) ) )
) {
	return;
}
...
if ( ! defined( 'WEBTOFFEE_SMARTCOUPON_VERSION' ) ) {
	define( 'WEBTOFFEE_SMARTCOUPON_VERSION', '2.2.4' );
}
