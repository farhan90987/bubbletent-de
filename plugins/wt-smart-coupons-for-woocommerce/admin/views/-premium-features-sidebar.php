...
$custom_tick = '<img src="' . esc_url( WT_SMARTCOUPON_MAIN_URL ) . 'admin/images/prem_crown.svg" alt="' . esc_attr__( 'Crown', 'wt-smart-coupons-for-woocommerce' ) . '" style="margin-right:9.5px;">';
?>
	...
	<div class="wt_smart_coupon_premium">
		...
		<div class="wt_sc_upgrade_pro_content">
			...
			<ul class="ticked-list">
				<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Create advanced BOGO coupons', 'wt-smart-coupons-for-woocommerce' ); ?></li>
				<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Offer store credits and gift cards', 'wt-smart-coupons-for-woocommerce' ); ?></li>
				<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Set up smart giveaway campaigns', 'wt-smart-coupons-for-woocommerce' ); ?></li>
				<div class="wt-sc-pro-features-all-features">
					<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Bulk generate coupons', 'wt-smart-coupons-for-woocommerce' ); ?></li>
					<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Coupons to boost conversion rate:', 'wt-smart-coupons-for-woocommerce' ); ?></li>
					...
					<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Create day-specific deals', 'wt-smart-coupons-for-woocommerce' ); ?></li>
					<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Display coupon banners and widgets', 'wt-smart-coupons-for-woocommerce' ); ?></li>
					<li><?php echo wp_kses_post( $custom_tick ); ?></span><?php esc_html_e( 'Import coupons', 'wt-smart-coupons-for-woocommerce' ); ?></li>
				</div>
