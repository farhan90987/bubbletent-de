	...
	public function coupon_usage_restriction_fields( $post_id ) {
		...
		if ( ! $hide_usage_restriction_pro_cta ) {
			printf(
				...
				sprintf(
					...
					esc_html__( '%1$s %2$s Did You Know? %3$s You can now get full control over coupon stacking—choose which discounts can and cannot be combined with Smart Coupons Pro!', 'wt-smart-coupons-for-woocommerce' ),
				...
				sprintf(
					...
					esc_html__( 'Check out plugin %s', 'wt-smart-coupons-for-woocommerce' ),
		...
		woocommerce_wp_radio(
			array(
				...
				'description' => sprintf(
					...
					__( '%1$s Any: %2$s Applies coupon if any of the products from the below is available in the cart.', 'wt-smart-coupons-for-woocommerce' ),
					'<b>',
					'</b>'
				) . '<br />' . sprintf(
					// translators: 1: bold tag opening, 2: bold tag closing.
					__( '%1$s All: %2$s Applies coupon if the cart contains all of the listed products.', 'wt-smart-coupons-for-woocommerce' ),
					'<b>',
					'</b>'
				),
			)
		...
		woocommerce_wp_radio(
			array(
				...
				'description' => sprintf(
					// translators: 1: bold tag opening, 2: bold tag closing.
					__( '%1$s Any: %2$s Applies coupon if the eligible quantity of products from any of the below selected categories are available in the cart.', 'wt-smart-coupons-for-woocommerce' ),
					'<b>',
					'</b>'
				) . '<br />' . sprintf(
					// translators: 1: bold tag opening, 2: bold tag closing.
					__( '%1$s All: %2$s Applies coupon if the cart contains the eligible quantity of products from all of the below listed categories.', 'wt-smart-coupons-for-woocommerce' ),
					'<b>',
					'</b>'
				),
			)
		...
		switch ( $type ) {
			...
			case 'exclude_product':
				$discount_type_help = array(
					...
					'fixed_cart'               => __( 'The coupon is not applicable when the cart contains an excluded product.', 'wt-smart-coupons-for-woocommerce' ),
				);
				break;
			...
			case 'exclude_category':
				$discount_type_help = array(
					...
					'fixed_cart'               => __( 'The coupon is not applicable when the cart contains products from an excluded category.', 'wt-smart-coupons-for-woocommerce' ),
				);
				break;
