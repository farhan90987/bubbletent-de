...
<div class="wt_sc_url_coupon_upgrade_to_pro">
	<div class="wt_sc_url_coupon_upgrade_to_pro_head">
		<div style="display:inline-block;"><img src="<?php echo esc_attr( $image_path ); ?>url_pro_icon.svg"><?php esc_html_e( 'Make the most out of URL coupons with URL coupons Pro', 'wt-smart-coupons-for-woocommerce' ); ?></div>
	</div>
	<table>
		<tr>
			<td>
				<ul class="wt_sc_url_pro_features">
					<li>
						...
						<b><?php esc_html_e( 'Custom URLs', 'wt-smart-coupons-for-woocommerce' ); ?></b>: <?php esc_html_e( 'Generate customized coupon URLs (example:www.mystore.com/happybirthday)', 'wt-smart-coupons-for-woocommerce' ); ?>
					</li>
					<li>
						<span class="wt_sc_icon_box">
							<span class="dashicons dashicons-yes-alt"></span>
						</span>
						<b><?php esc_html_e( 'Set up a redirect page', 'wt-smart-coupons-for-woocommerce' ); ?></b>: <?php esc_html_e( 'Configure the URL to redirect to either cart or checkout page when it is clicked.', 'wt-smart-coupons-for-woocommerce' ); ?>
					</li>
				</ul>
			</td> 
			<td>
				<ul class="wt_sc_url_pro_features">
					<li>
						...
						<b><?php esc_html_e( 'Create QR code coupons', 'wt-smart-coupons-for-woocommerce' ); ?></b>: <?php esc_html_e( 'Embed URL coupons in QRCodes to create QR code coupons.', 'wt-smart-coupons-for-woocommerce' ); ?>
					</li>
					<li>
						<span class="wt_sc_icon_box">
							<span class="dashicons dashicons-yes-alt"></span>
						</span>
						<b><?php esc_html_e( 'Automatically add products', 'wt-smart-coupons-for-woocommerce' ); ?></b>: <?php esc_html_e( 'Assign a product to the URL to be automatically added to the customer’s cart upon activating it.', 'wt-smart-coupons-for-woocommerce' ); ?>
					</li>                 
				</ul>
			</td>
		</tr>
	...
	<div style="text-align:center;">
		<a href="https://www.webtoffee.com/product/url-coupons-for-woocommerce/?utm_source=free_plugin_CTA&utm_medium=smart_coupons_basic&utm_campaign=URL_Coupons&utm_content=<?php echo esc_attr( WEBTOFFEE_SMARTCOUPON_VERSION ); ?>" class="wt-sc-url-upgrade-to-pro-btn" target="_blank">
			<img src="<?php echo esc_attr( $image_path ); ?>pro_icon.svg"><?php esc_html_e( 'Upgrade to URL coupons Pro', 'wt-smart-coupons-for-woocommerce' ); ?>
		</a>
	</div>
</div>