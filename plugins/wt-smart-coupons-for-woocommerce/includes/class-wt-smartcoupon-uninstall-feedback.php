...
if ( ! class_exists( 'WT_SmartCoupon_Uninstall_Feedback' ) ) :
	...
	class WT_SmartCoupon_Uninstall_Feedback {
		...
		private function get_uninstall_reasons() {
			...
			$reasons = array(
				...
				array(
					'id'          => 'upgraded-to-pro',
					'text'        => __( 'Upgraded to premium version', 'wt-smart-coupons-for-woocommerce' ),
			...
			<div class="smartcoupon-modal" id="smartcoupon-smartcoupon-modal">
				<div class="smartcoupon-modal-wrap">
					<div class="smartcoupon-modal-header">
						<h3><?php esc_html_e( 'If you have a moment, please let us know why you are deactivating:', 'wt-smart-coupons-for-woocommerce' ); ?></h3>
					</div>
					<div class="smartcoupon-modal-body">
						...
						<div class="wt_sc_policy_infobox">
							<?php esc_html_e( "We do not collect any personal data when you submit this form. It's your feedback that we value.", 'wt-smart-coupons-for-woocommerce' ); ?>
							<a href="https://www.webtoffee.com/privacy-policy/" target="_blank"><?php esc_html_e( 'Privacy Policy', 'wt-smart-coupons-for-woocommerce' ); ?></a>        
						</div>
					</div>
					<div class="smartcoupon-modal-footer">
						<a href="#" class="dont-bother-me"><?php esc_html_e( 'I rather wouldn\'t say', 'wt-smart-coupons-for-woocommerce' ); ?></a>                      
						<a href="https://wordpress.org/support/plugin/wt-smart-coupons-for-woocommerce/#bbp_topic_title" target="_blank" class="button-primary smartcoupon-model-submit"><span class="dashicons dashicons-external" style="margin-top:3px;"></span> <?php esc_html_e( 'Contact Support', 'wt-smart-coupons-for-woocommerce' ); ?></a>
						<button class="button-primary smartcoupon-model-submit"><?php esc_html_e( 'Submit & Deactivate', 'wt-smart-coupons-for-woocommerce' ); ?></button>
						<button class="button-secondary smartcoupon-model-cancel"><?php esc_html_e( 'Cancel', 'wt-smart-coupons-for-woocommerce' ); ?></button>
					</div>
				</div>
			</div>
					...
					$(function () {
						...
						modal.on('click', 'input[type="radio"]', function () {
							...
							if ('reviewhtml' === inputType) {
								reasonInputHtml = '<div class="reviewlink reason-block"><a href="#" target="_blank" class="review-and-deactivate"><?php esc_html_e( 'Deactivate and leave a review', 'wt-smart-coupons-for-woocommerce' ); ?> <span class="wt-smartcoupon-rating-link"> &#9733;&#9733;&#9733;&#9733;&#9733; </span></a></div>';
							} else if( 'supportlink' === inputType ) {
								reasonInputHtml = '<div class="support_link reason-block"> <a href="https://wordpress.org/support/plugin/wt-smart-coupons-for-woocommerce/#bbp_topic_title" target="_blank" class="reach-via-support"><?php esc_html_e( 'Let our support team help you', 'wt-smart-coupons-for-woocommerce' ); ?> </a>' + '</div>';
							} else {
		...
		public function send_uninstall_reason() {
			...
			$resp = wp_remote_post(
				'https://feedback.webtoffee.com/wp-json/smartcoupon/v1/uninstall',
				array(
					'method'      => 'POST',
					'timeout'     => 45,
					'redirection' => 5,
	...
	new WT_SmartCoupon_Uninstall_Feedback();
