			...
			<table class="form-table wt-iew-form-table">
				...
				<tr>
					...
					<td>
						...
						<span class="wt-iew_form_help"><?php _e("Enter your FTP port.", 'wt-import-export-for-woo'); ?></span>
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<th><label><?php _e("Use FTPS", 'wt-import-export-for-woo'); ?></label></th>
					<td>
				...
				<tr>
					<th><label><?php _e("Enable Passive mode", 'wt-import-export-for-woo'); ?></label></th>
					<td>
				...
				<tr>
					<th><label><?php _e("Is SFTP", 'wt-import-export-for-woo'); ?></label></th>
					<td>
