...
define( 'PYS_SUPER_PACK_VERSION', '6.1.0' );
define( 'PYS_SUPER_PACK_PRO_MIN_VERSION', '12.3.0' );
...
define( 'PYS_SUPER_PACK_PLUGIN_ICON', PYS_SUPER_PACK_URL . '/dist/images/pys-logo.svg');
