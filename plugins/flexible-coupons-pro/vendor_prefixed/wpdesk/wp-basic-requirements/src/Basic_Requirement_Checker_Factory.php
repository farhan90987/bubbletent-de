...
if (!\class_exists('FlexibleCouponsProVendor\Basic_Requirement_Checker')) {
    require_once __DIR__ . '/Basic_Requirement_Checker.php';
}
if (!\class_exists('FlexibleCouponsProVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-coupons-pro';
    /**
