	...
	function __construct() {
		...
		$this->product_fields = array(
			...
			'id_prefix'                     => array(
				...
				'inputtype'  => 'text',
				'setting'    => true,
				'feed_type'  => array( 'facebook', 'google', 'pinterest', 'adsensecustom', 'tiktok', 'reddit' ),
				'filterattr' => 'id',
				'CDATA'      => false,
...
//                'NotStripTags'     => true,
			...
			'condition'                     => array(
				...
				'feed_type' => array( 'facebook', 'google', 'pinterest', 'tiktok', 'reddit' ),
				'length'    => false,
				'type'      => 'notoutput',
				'define'    => true,
				'xml'       => 'g:condition',
			...
			'gtin'                          => array(
				...
				'feed_type'  => array( 'facebook', 'google', 'pinterest', 'tiktok', 'googleReviews', 'reddit' ),
				'length'     => 100,
//                'canSetCustomValue' => true,
				'xml'        => 'g:gtin',
				'csv'        => 'gtin',
...
//                'canSetCustomValue' => true,
			...
			'size_type'                     => array(// For Google Feed
				...
				'feed_type'         => array( 'google', 'pinterest', 'reddit' ),
				'length'            => false,
			...
			'expand_more_images'            => array(
				'feed_type' => array( 'google', 'pinterest', 'facebook', 'tiktok', 'reddit' ),
				'length'    => false,
				'type'      => 'automap',
            ...
            */
			...
			'mobile_link'                   => array(
				'header'    => 'mobile_link',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:mobile_link',
				'csv'       => 'mobile_link',
			),
			'platform_specific_link'        => array(
				'header'    => 'platform_specific_link',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:platform_specific_link',
				'csv'       => 'platform_specific_link',
			),
			'average_review_rating'         => array(
				'header'    => 'average_review_rating',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:average_review_rating',
				'csv'       => 'average_review_rating',
			),
			'number_of_ratings'             => array(
				'header'    => 'number_of_ratings',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:number_of_ratings',
				'csv'       => 'number_of_ratings',
			),
			'custom_number_0'               => array(
				'header'    => 'custom_number_0',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:custom_number_0',
				'csv'       => 'custom_number_0',
			),
			'custom_number_1'               => array(
				'header'    => 'custom_number_1',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:custom_number_1',
				'csv'       => 'custom_number_1',
			),
			'custom_number_2'               => array(
				'header'    => 'custom_number_2',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:custom_number_2',
				'csv'       => 'custom_number_2',
			),
			'custom_number_3'               => array(
				'header'    => 'custom_number_3',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:custom_number_3',
				'csv'       => 'custom_number_3',
			),
			'custom_number_4'               => array(
				'header'    => 'custom_number_4',
				'feed_type' => array( 'reddit' ),
				'type'      => array( 'dashboardExtra' ),
				'xml'       => 'g:custom_number_4',
				'csv'       => 'custom_number_4',
			),
...
//			file_put_contents( $this->feedBaseDir . 'cron-wpfeed.log', date( "Y-m-d H:i:s" ) . "\trun_scheduled_feeds: no jobs\n", FILE_APPEND );
	...
	/**
	 * Retrieves the IDs of categories that are marked as excluded in category settings.
	 *
	 * @return array An array of category IDs that are excluded. If no categories are excluded, returns an empty array.
	 */
	static function get_ids_excluded_categories_in_cat_settings() {
		$excluded_cat_ids = get_terms( array(
		...
		if ( is_wp_error( $excluded_cat_ids ) ) {
			error_log( 'WPWOOF Error in get_ids_excluded_categories_in_cat_settings: ' . $excluded_cat_ids->get_error_message() );

			return array();
		}

		return ! empty( $excluded_cat_ids ) ? array_map( 'intval', $excluded_cat_ids ) : array();
	}
}
