...
?>
    ...
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-fb_localize stl-fb_country stl-google_local_inventory stl-reddit">
		...
		if ( WoocommerceWpwoofCommon::isActivatedWPML() ) { ?>
            <script type="text/javascript">
                var wpwoof_wpml_default_lang = "<?php echo icl_get_default_language();?>";
            </script>
            ...
            <table class="form-table wpwoof-addfeed-top">
                <tr class="addfeed-top-field wpwoof-open-popup-wrap">
                    ...
                    <td class="addfeed-top-value">
                        <select name="feed_use_lang" class="do_filter_categories">
							<?php
                ...
                <?php if ( ! ( ! defined( 'ICL_SITEPRESS_VERSION' ) || version_compare( ICL_SITEPRESS_VERSION, '4.0', '<' ) ) ): ?>
                    <tr id="feed-setting-translations-row" class="addfeed-top-field">
                        <th class="addfeed-top-label"><?php echo __( 'Translations:', 'woocommerce_wpwoof' ); ?></th>
                        <td class="addfeed-top-value">
                            <label class="p_inline_block" style="display: inline-block;">
                                <input name="translatable_fallback" type="hidden" value="0"/>
                                <input name="translatable_fallback" value="1" class="do_filter_categories" id="translatable_fallback"
                                       type="checkbox" <?php echo checked( ! empty( $wpwoof_values['translatable_fallback'] ) )
                                ?>>Include products with no translation in the feeds</label>
                            <p>Requires the WPML option enabled: "Translatable - use translation if available or
                                fallback to default language"</p>
                        </td>
                    </tr>
                <?php endif; ?>
            </table><?php
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		?></div>
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-reddit"><?php
		/* Output ID field */
    ...
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-fb_country stl-google_local_inventory stl-reddit">
		...
		<?php } ?>
        <table class="form-table wpwoof-addfeed-top stl-facebook stl-google stl-adsensecustom stl-tiktok stl-reddit">
            <tr class="addfeed-top-field">
...
?>
    <div class="stl-facebook stl-google stl-pinterest stl-tiktok stl-reddit">
        <hr class="wpwoof-break"/>
...
////////////////////////////////////////////////////////////////// FILTER BLOCk  //////////////////////////////////////////////////////////////////////////////////////
?>
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-googleReviews stl-reddit">
        <hr class="wpwoof-break"/>
        ...
        <div class="filter_flex">
            <div class="wpwoof-addfeed-top">
                <div class="filter_flex_section">
                    ...
                    <label class="addfeed-top-label" for="feed_include_excluded">Add products or categories with the "exclude" option turned ON.</label>
                </div>
                <div class="filter_flex_section stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-reddit">
                ...
                <div class="filter_flex_section">
					...
					if ( ! empty( $wpwoof_values['feed_variation_show_main'] ) ) {
						echo ' checked ';
					} ?> />
...
?>
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-reddit">
        <hr class="wpwoof-break"/>
...
?>
    <div class="stl-facebook stl-google stl-pinterest stl-adsensecustom stl-tiktok stl-googleReviews stl-fb_localize stl-reddit">
        <hr class="wpwoof-break"/>
