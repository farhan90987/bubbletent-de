                    ...
                    <tr>
                        ...
                        <td class="input-cell" style="min-width: 550px;">
							...
							if ( $isCustomTag ):?>
                                ...
                                <div class="extra-input__item">
                                    <input type="checkbox" name="extra[<?= $key ?>][feed_type][reddit]"
                                           id="extra[<?= $key ?>][feed_type][reddit]" <?php checked( isset( $value['feed_type']['reddit'] ) ); ?>>
                                    <label for="extra[<?= $key ?>][feed_type][reddit]">Reddit</label>
                                </div>
                                <div class="extra-input__item">
                                    <br><br>
        ...
        <table id="wpwoof-def-extra-row" style="display: none">
            <tr>
                ...
                <td class="input-cell" style="min-width: 550px;">
                    ...
                    <div class="extra-input__item">
                        <input type="checkbox" name="wpwoof-def[feed_type][reddit]" checked>
                        <label for="wpwoof-def[feed_type][reddit]">Reddit</label>
                    </div>
                    <div class="extra-input__item">
                        <br><br>
