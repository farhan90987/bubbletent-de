...
class Wt_Import_Export_For_Woo_Product_Tags {
    ...
    */
    public function importer_steps($steps, $base)
    {
        ...
        {
            $steps['advanced']['description']=__('Use advanced options from below to decide updates to existing tags, batch import count or schedule an import. You can also save the template file for future imports.', 'wt-import-export-for-woo');
        }
        return $steps;
    }
