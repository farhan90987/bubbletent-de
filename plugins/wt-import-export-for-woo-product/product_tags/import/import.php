...
class Wt_Import_Export_For_Woo_Tags_Import {
        ...
        foreach ($import_data as $key => $data) {
            ...
            if (!is_wp_error($parsed_data)) {
                ...
                if (!is_wp_error($result)) {
                    ...
                    $this->import_results[$row] = array('row' => $row, 'message' => $msg, 'status' => true, 'status_msg' => __('Success', 'wt-import-export-for-woo'), 'post_id'=>$result['id'], 'post_link' => Wt_Import_Export_For_Woo_Product_Tags::get_item_link_by_id($result['id'])); 
