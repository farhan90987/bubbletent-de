	...
	public function add_services_fields_for_packaging( $post_or_order_object ) {
		...
		if (
			...
			$order->has_shipping_method( Home_Delivery::get_instance()->id )
                        ...
                        $label_meta         = new Internetmarke_Label_Meta( $order );
                        $download_available = ( '' !== $order->get_meta( '_wgm_internetmarke_output_type' ) && $label_meta->has_meta( '_wgm_internetmarke_binary_label_data' ) );
