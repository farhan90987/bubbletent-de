...
if ( ! class_exists( 'Woocommerce_Invoice_Pdf' ) ) {
	...
	class Woocommerce_Invoice_Pdf {
		...
		public function autoload( $class ) {
			...
			if ( self::has_php_8_2_for_swiss_qr_codes() ) {
		...
		private static function init() {
			...
			WP_WC_Invoice_Pdf_Email_Attachment::init_refund_attachments();
		...
		*/
		 ...
		 * @return Boolean
		 */
		public static function has_php_8_2_for_swiss_qr_codes() {
			return apply_filters( 'wp_wc_invoice_pdf_has_php_8_2_for_swiss_qr_codes', version_compare( PHP_VERSION, '8.2.0', '>' ) );
		}
