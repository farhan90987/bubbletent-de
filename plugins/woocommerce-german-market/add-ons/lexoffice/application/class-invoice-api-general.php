...
if ( ! class_exists( 'German_Market_Lexoffice_Invoice_API_General' ) ) {
	...
	class German_Market_Lexoffice_Invoice_API_General {
		...
		* Depreacted since 3.52, inly returnd invoice id
		* 
		...
		* @return String
		*/ 
		public static function download_pdf_document( $voucher_id, $invoice_or_credit_note = 'invoice' ) {

			$endpoint = 'invoice' === $invoice_or_credit_note ? 'invoices' : 'credit-notes';
			...
			curl_setopt_array( $curl, 
				...
				array(
					CURLOPT_URL => German_Market_Lexoffice_API_Auth::get_base_url() . "v1/" . $endpoint . "/" . $voucher_id . "/file",
					CURLOPT_RETURNTRANSFER => true,
					CURLOPT_ENCODING => "",
					CURLOPT_MAXREDIRS => 10,
					CURLOPT_TIMEOUT => 30,
