...
class WCB_Customer_Updater
{
    ...
    {
        $data = array(
            'name' => isset($user_meta['billing_company'][0]) ? $user_meta['billing_company'][0] : '',
            'street' => isset($user_meta['billing_address_1'][0]) ? $user_meta['billing_address_1'][0] : '',
            'zip' => isset($user_meta['billing_postcode'][0]) ? $user_meta['billing_postcode'][0] : '',
            'city' => isset($user_meta['billing_city'][0]) ? $user_meta['billing_city'][0] : '',
            'country_code' => isset($user_meta['billing_country'][0]) ? $user_meta['billing_country'][0] : '',
            ...
            'email' => isset($user_meta['billing_email'][0]) ? $user_meta['billing_email'][0] : '',
        );
