...
if($top_layout == 'half') {
	include_once( MWEW_DIR_PATH . 'templates/archive-listing-split.php' );
} else { ?>
		...
		<?php endif; ?>
			...
			<?php switch ($layout) {
				...
				case 'left-sidebar':
					...
					break;
				case 'right-sidebar':
					?><div class="col-lg-9 col-md-8 padding-right-30 listings-column-content mobile-content-container <?php if($layout== 'right-sidebar' && $mobile_layout=="left-sidebar") { echo "col-lg-pull-3"; }  ?> "><?php
					break;
