...
<div id="woe-admin" class="container-fluid wpcontent">
    <form>
        ...
        <div class="woe-tab" id="woe-tab-general">
            <div class="woe-box woe-box-main">
                <h3 class="woe-box-title"><?php esc_html_e( 'Export settings', 'woocommerce-order-export' ) ?></h3>
                <div class="row">
                    ...
                    <div class="col-sm-8 form-group woe-input-simple">
                        <select id="tools-export-selector">
                            ...
                            <option data-json='<?php echo json_encode( $settings_export[ WC_Order_Export_Manage::EXPORT_NOW ],
								...
								<?php esc_html_e( 'Export now', 'woocommerce-order-export' ) ?></option>
    ...
    <form method="post">
        <div class="woe-tab" id="woe-tab-general">
            <div class="woe-box woe-box-main">
                <h3 class="woe-box-title"><?php esc_html_e( 'Import settings', 'woocommerce-order-export' ) ?></h3>
                <div class="row">
                    <div class="col-sm-12 form-group">
                ...
                <div class="row">
                    <div class="col-sm-2 form-group col-md-offset-7">
                        ...
                        <input type="submit" class="woe-btn-tools"
                               value="<?php esc_html_e( 'Import', 'woocommerce-order-export' ) ?>" name="woe-tools-import"
                               id="submit-import">
...
<script>
	jQuery( function ( $ ) {
		...
		jQuery( '#submit-import' ).on( 'click', function ( e ) {
            ...
            let defaultWarning = '<?php esc_attr_e( 'Are you sure to continue?', 'woocommerce-order-export' ) ?>';
